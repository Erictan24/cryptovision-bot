...
class TelegramBot:
    ...
    async def cmd_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        text = (
            ...
            "─── 📊 CHART & ANALISA ────────────\n"
            "  /chart [coin] [tf]   — Chart profesional\n"
            "                         Order Block, FVG,\n"
            "                         Trendline, RSI, BOS\n"
            ...
            "  /daily               — Scan semua coin\n"
            "  /market              — Overview pasar\n"
            "  /whale [coin]        — Aktivitas whale\n\n"
            "─── 💼 TRADING & POSISI ────────────\n"
            "  /trade               — Status auto trade\n"
            "  /positions           — Posisi aktif + PnL\n"
            "  /monitor             — Aktifkan TP1 monitor\n"
